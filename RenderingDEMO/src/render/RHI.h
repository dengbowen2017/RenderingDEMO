...
namespace RenderingDEMO
{
	...
	public:
		...
		virtual std::shared_ptr<VertexShader> CreateVertexShader(const std::string& file_path) = 0;
		virtual std::shared_ptr<PixelShader> CreatePixelShader(const std::string& file_path) = 0;
