...
namespace RenderingDEMO
{
	...
	void MainPass::Draw()
	{
		...
		m_RHI->UpdateUniformBuffer(m_RenderResource->m_PerObjectUniformBuffer, &m_RenderResource->m_PlaneHConstant);
		m_RHI->SetVertexBuffer(m_RenderResource->m_PlaneVertexBuffer);
		m_RHI->DrawIndexed(m_RenderResource->m_PlaneIndexBuffer);

		m_RHI->UpdateUniformBuffer(m_RenderResource->m_PerObjectUniformBuffer, &m_RenderResource->m_PlaneVConstant);
		m_RHI->SetVertexBuffer(m_RenderResource->m_PlaneVertexBuffer);
		m_RHI->DrawIndexed(m_RenderResource->m_PlaneIndexBuffer);
